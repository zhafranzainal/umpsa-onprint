        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('deliveries.index') }}">
                        Deliveries
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\DeliveryOption::class)
                        <x-dropdown-link href="{{ route('delivery-options.index') }}">
                        Delivery Options
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Outlet::class)
                        ...
                        @endcan
                        @can('view-any', App\Models\Rider::class)
                        <x-dropdown-link href="{{ route('riders.index') }}">
                        Riders
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Delivery::class)
                <x-responsive-nav-link href="{{ route('deliveries.index') }}">
                Deliveries
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\DeliveryOption::class)
                <x-responsive-nav-link href="{{ route('delivery-options.index') }}">
                Delivery Options
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Feedback::class)
                ...
                @endcan
                @can('view-any', App\Models\Inventory::class)
                <x-responsive-nav-link href="{{ route('inventories.index') }}">
                Inventories
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Outlet::class)
                <x-responsive-nav-link href="{{ route('outlets.index') }}">
                Outlets
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Package::class)
                ...
                @endcan
                @can('view-any', App\Models\Rider::class)
                <x-responsive-nav-link href="{{ route('riders.index') }}">
                Riders
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
